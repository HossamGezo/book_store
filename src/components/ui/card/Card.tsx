    ...
    <div className="card group h-[500px] w-[330px] lg:w-[311px] py-1.5 rounded-lg bg-white shadow-normal border-t-2 border-t-transparent hover:scale-[1.01] hover:-translate-y-1.5 hover:shadow-scale hover:border-t-2 hover:border-t-primary/65 transition-all duration-500">
      ...
      <div className="card-desc p-1.5">
        ...
        <div className="rating my-2.5">
          ...
          <div className="rating-price text-center mt-1.5 text-2xl text-red-700 font-bold">
            ${price}
          </div>
        </div>
        <div className="card-icons flex-center gap-3.5 text-xl pt-3 border-t-2 border-t-primary/45 group-hover:border-t-primary/65">
          <FaEye
