  ...
  return (
    <div className="flex flex-col">
      <div className="custom-container grow py-10">
        <h1 className="text-3xl md:text-5xl font-jetbrains mb-5 underline text-primary">
          About Us
        </h1>
        <div className="text-xl font-light lg:text-justify leading-relaxed">
          <p className="mb-2.5">
            Welcome to our online bookstore — a space built for readers,
            thinkers, and knowledge seekers. We believe that every book holds
            the power to inspire, transform, and open doors to new worlds. That
            belief is the foundation of everything we do.
          </p>
          <p className="mb-2.5">
            ...
            self-help titles, we curate our collection with care to ensure there
            is something meaningful for every reader.
          </p>
          <h3 className="font-medium text-2xl mb-2.5 text-primary">
            We are committed to providing
          </h3>
          <ul className="*:ml-10 mb-2.5">
          ...
          <p className="mb-2.5">
            ...
            reading list, we’re here to support your journey. Our mission is to
            become your go-to destination for books — a place where discovering
            your next great read feels effortless and enjoyable.
          </p>
          <p>
